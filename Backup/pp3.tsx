...
//                                 <Image src={testimonial.image} alt={testimonial.name} width={50} height={50} className="rounded-5xl"/>
//                                 <div>
      ...
      <div className="bg-[#0A192F] font-inter">
                ...
                <div className="px-8 pt-2 pb-8 space-y-4">
                  {navItems.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      onClick={toggleMenu}
                      className="block text-gray-300 hover:text-[#C04000] text-lg font-medium"
                    >
                      {item.name}
                    </Link>
                  ))}
                  <button className="mt-4 bg-[#C04000] text-white px-6 py-3 rounded-full font-semibold w-full">
                    Get Started
                  </button>
                </div>
              </motion.div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="mt-6 text-lg text-gray-300 max-w-lg mx-auto lg:mx-0">
                  We deliver cutting-edge technology solutions designed for unparalleled performance,
                  scalability, and business growth.
                </p>
                <motion.div className="mt-10" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    href="#products"
                    className="inline-flex items-center gap-3 bg-[#C04000] text-white px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-opacity-90 transition-all duration-300"
                  >
                    Explore Solutions <ArrowRight size={20} />
                  </Link>
                </motion.div>
        ...
        <section className="py-16 bg-[#0A192F]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {["Next.js", "React", "Vercel", "AWS", "TailwindCSS", "Framer Motion"].map((tech) => (
                <motion.p key={tech} variants={FADE_IN} className="text-gray-500 text-2xl font-semibold">
                  {tech}
                </motion.p>
              ))}
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                {
                  title: "Scalable Apps",
                  description: "Build lightning-fast, responsive web applications that grow with your business.",
                ...
                },
                {
                  ...
                  description:
                    "Harness the power of AI to create intelligent, predictive, and user-centric experiences.",
                  image: "/pp2.png",
                  icon: "🧠",
                },
                {
                  title: "E-Commerce",
                  description:
                    "Craft seamless, high-converting online stores that deliver exceptional customer journeys.",
                ...
                >
                  ...
                  <div className="p-8">
                    <h3 className="text-2xl font-bold text-[#112B9D] mb-3">
        ...
        <section id="features" className="py-24 bg-[#0A192F] text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                {
                  icon: <Zap className="w-8 h-8 text-[#C04000]" />,
                  title: "Blazing Fast Speed",
                  description: "Optimized for performance with global edge network deployment.",
                },
                {
                  icon: <Cloud className="w-8 h-8 text-[#C04000]" />,
                  title: "Auto-Scaling",
                  description: "Infrastructure that scales automatically to handle any traffic spike.",
                },
                {
                  icon: <BarChart2 className="w-8 h-8 text-[#C04000]" />,
                  title: "Real-time Analytics",
                  description: "Gain actionable insights into your application's performance and usage.",
                },
                {
                  icon: <ShieldCheck className="w-8 h-8 text-[#C04000]" />,
                  title: "Enterprise-Grade Security",
                  description: "Protect your data with robust security measures and compliance.",
                },
                {
                  icon: <LifeBuoy className="w-8 h-8 text-[#C04000]" />,
                  title: "24/7 Expert Support",
                  description: "Our dedicated team is here to help you around the clock.",
                },
                {
                  icon: <CheckCircle2 className="w-8 h-8 text-[#C04000]" />,
                  title: "Seamless Integrations",
                  description: "Connect easily with your favorite tools and third-party services.",
                },
              ].map((feature, i) => (
                <motion.div key={i} variants={FADE_IN} className="flex items-start space-x-4">
                  <div className="flex-shrink-0 bg-white/10 p-4 rounded-full">{feature.icon}</div>
        ...
        <section
          id="community"
          className="py-24 bg-[#112B9D] text-white bg-cover bg-center"
          style={{
            backgroundImage: "linear-gradient(rgba(17, 43, 157, 0.95), rgba(17, 43, 157, 0.95)), url('/ppbg.png')",
          }}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              {[
                {
                  ...
                  quote:
                    "Pijina Poojary transformed our app development. The speed and reliability are unmatched. It's the robust core our tech stack needed.",
                ...
                },
                {
                  ...
                  quote:
                    "The AI integration tools are a complete game-changer. Our user engagement metrics have never been better. Truly remarkable.",
                  image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330",
                },
                {
                  name: "Michael Chen",
                  role: "E-Commerce Owner, ShopFast",
                  quote:
                    "Our sales and conversion rates skyrocketed after migrating to their e-commerce platform. It's seamless, fast, and incredibly powerful.",
                ...
                <motion.div
                  key={i}
                  variants={FADE_IN}
                  className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 shadow-lg flex flex-col"
                >
                  <div className="flex mb-4">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className="text-[#C04000]">
                        ★
                      </span>
                    ))}
                  </div>
        ...
        <section id="ecosystem" className="py-24 bg-gradient-to-r from-[#C04000] to-[#e05a20]">
          ...
          >
            <h2 className="text-4xl font-extrabold text-white tracking-tight">Ready to Build Your Future?</h2>
            <p className="mt-5 text-lg text-white/90 max-w-3xl mx-auto">
              Join a thriving community of innovators. Unlock exclusive tools, resources, and support to
              accelerate your next big idea today.
            </p>
            <motion.div className="mt-10" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="#"
                className="inline-block bg-white text-[#112B9D] px-10 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-gray-100 transition-all duration-300"
              >
                Start Your Project Now
              </Link>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <ul className="space-y-3">
                  {navItems.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="hover:text-[#C04000] transition-colors duration-300 text-sm"
                      >
                        {item.name}
                      </Link>
                    </li>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li>
                    <a
                      href="mailto:support@pijinapoojary.com"
                      className="hover:text-[#C04000] transition-colors duration-300"
                    >
                      support@pijinapoojary.com
                    </a>
                  </li>
                  <li>
                    <a
              ...
              <div>
                <h4 className="text-md font-semibold text-white tracking-wider uppercase mb-4">Follow Us</h4>
                <div className="flex space-x-4">
                  <a href="#" className="hover:text-[#C04000] transition-colors duration-300">
                    <Twitter size={20} />
                  </a>
                  <a href="#" className="hover:text-[#C04000] transition-colors duration-300">
                    <Linkedin size={20} />
            ...
            <div className="mt-12 border-t border-gray-800 pt-8 text-center">
              <p className="text-sm text-gray-500">
                © {new Date().getFullYear()} Pijina Poojary Solutions. All Rights Reserved.
              </p>
            </div>
          </div>
        </footer>
